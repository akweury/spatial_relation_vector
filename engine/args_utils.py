...
def paser():
    ...
    parser.add_argument('--batch_size', '-b', default=1, type=int, help='Mini-batch size (default: 2)')
    ...
    parser.add_argument('--top_data', type=int, help='Select number of data for the dataset.')
